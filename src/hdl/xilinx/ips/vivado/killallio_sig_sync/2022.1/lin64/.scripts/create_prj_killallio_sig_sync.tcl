...
# Tool version: 2022.1
# Description: TCL script for re-creating Vivado project 'killallio_sig_sync'
#
...
set PRJ_DIR ".."
set prj_name "killallio_sig_sync"
...
if {$PRJ_TYPE == "DESIGN_PRJ_TYPE"} {
  ...
  # add IPs source files
  set vhdl_ips_file_list [findFiles ${ip_dir}/killallio_sig_sync/src/hdl *.vhd]
